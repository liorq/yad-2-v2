...
export const topSidebarItems = [
  {
     title:{ isHalfRectangleNeeded:false,label: 'נדלן', url: '/chat/v2/inbox?serviceInitiator=Header',iconPath:''  },
